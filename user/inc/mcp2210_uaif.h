...
typedef struct mcp2210_uaif_s
{
    ...
    int                 (*set_volume)       (struct mcp2210_uaif_s *, int *, RECORD_VOLUME_S *);
    int                 (*get_volume)       (struct mcp2210_uaif_s *, uint8_t, const RECORD_VOLUME_S *);
    int                 (*nwm_pairing)      (struct mcp2210_uaif_s *, uint8_t *);
} MCP2210_UAIF_S;
